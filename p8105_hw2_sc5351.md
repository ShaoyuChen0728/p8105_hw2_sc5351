...
```
    ...
    ##  4     4        69.8 Female        16 no carrier .           
    ##  5     5        66   Male          16 no carrier 68.7        
    ##  6     6        62.5 Male          16 no carrier .           
    ##  7     7        66.5 Male          18 no carrier 74          
    ##  8     8        67.2 Female        18 no carrier .           
    ##  9     9        66.7 Female        16 no carrier .           
    ## 10    10        64.1 Female        18 no carrier .           
    ## # ℹ 473 more rows
...
```
    ...
    ##  2     5        66   Male          16 no carrier 68.7        
    ##  3     7        66.5 Male          18 no carrier 74          
    ##  4    13        63.1 Male          12 carrier    69          
    ##  5    14        58.4 Female        20 no carrier 66.2        
    ##  6    18        67.8 Male          16 no carrier 69.8        
    ##  7    22        67.3 Female        20 carrier    74.6        
    ##  8    26        64.8 Female        20 carrier    71.1        
    ##  9    30        66.3 Female        12 no carrier 73.1        
    ## 10    39        68.3 Female        16 carrier    70.2        
    ## # ℹ 87 more rows

Important steps in the import process are
